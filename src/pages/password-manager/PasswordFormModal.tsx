...
const PasswordFormModal: React.FC<PasswordFormModalProps> = ({ isOpen, editingId, formData, categories, registeredEmails, isPasswordVisible, onFormDataChange, onTogglePasswordVisibility, onOpenGenerator, onSave, onClose }) => {
  ...
  return <IonModal isOpen={isOpen} onDidDismiss={onClose}>
    ...
    <IonContent><div className="form-container">
      ...
      <IonItem><IonLabel position="stacked">メールアドレス</IonLabel><EmailSuggestionInput registeredEmails={registeredEmails} value={formData.email} onChange={(value) => updateField('email', value)} /></IonItem>
